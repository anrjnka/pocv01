...
public class CatalogVendorController {
	@PostMapping("/CatalogVendor")
    public ResponseEntity<List<CatalogVendor>> catalogVendor(@Validated @RequestBody User user) {
        List<CatalogVendor> result = catalogVendorService.catalogVendor(user);
