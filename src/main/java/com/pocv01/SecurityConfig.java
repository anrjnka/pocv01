    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeHttpRequests()
                ...
                .requestMatchers("/api/approval/getAllApproval").permitAll()
                .requestMatchers("/api/approval/getApproval/{id}").permitAll()
                .requestMatchers("/api/approval/createApproval").permitAll()
                .requestMatchers("/api/approval/delete/{id}").permitAll()
                .requestMatchers("/api/approval/update/{id}").permitAll()
                .requestMatchers("/api/approval/module").permitAll()       
                .requestMatchers("/api/module/getAllModule").permitAll()
                .requestMatchers("/api/module/getModule/{id}").permitAll()
                .requestMatchers("/api/module/createModule").permitAll()
                .requestMatchers("/api/module/delete/{id}").permitAll()
                .requestMatchers("/api/module/update/{id}").permitAll()
